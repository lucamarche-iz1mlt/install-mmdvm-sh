...
-	Scaricare winscp dal seguente link

https://winscp.net/eng/download.php?TB_iframe

e collegarsi alla raspberry cliccando su "nuovo sito" e inserire le credenziali,
all'appertura il programma si posizionerà in /home/pi/.

caricare la cartella trascinandola nel riquadro dove sono presenti tutte le cartelle di raspberry.

Andare su putty e digitare


sudo sh installazione_mmdvm/mmdvm.sh
